...
#instance de VehicleScraper en lui passant une liste d'UR Lsi
...
urls = ["https://www.autoscout24.be/fr/lst/audi/q8?atype=C&cy=B&desc=0&page=2&search_id=d02l2savys&sort=standard&source=listpage_pagination&ustate=N%2CU",
    ...
    "https://www.autoscout24.be/fr/lst/renault?atype=C&cy=B&damaged_listing=exclude&desc=0&page=2&powertype=kw&search_id=rrgkbayc3m&sort=standard&source=listpage_pagination&ustate=N%2CU",
    ...
    "https://www.autoscout24.be/fr/lst/volkswagen/caddy?atype=C&cy=B&desc=0&page=2&search_id=81kgzuh8rf&sort=standard&source=listpage_pagination&ustate=N%2CU"
